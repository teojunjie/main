...
[[Design-Architecture]]
=== Architecture
Let us look at the abstracted view of the application in order to get a feel of how everything is connected together.
...
[yellow]#The diagram above gives an overview on how Maker Manager stores its data.#

The diagram below shows how Maker Manager reads its data upon start up.
