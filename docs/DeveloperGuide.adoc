...
.. Download all the data files by navigating to the data folder from the root.
Download all 3 files and save the data files in a folder called 'data' in the same directory
in which you saved the jar file.
