...
==== Current Implementation
The two different access types are implemented with the help of an AdminSession object inside

*> insert admin class diagram*

*> insert sequence diagram*

*> insert activity diagram*

*> is there a design consideration?*
